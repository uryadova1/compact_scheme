...
$q^{n+1, k+1}_{j+1}(1 + r*u^{n+1, k}_{j+1}) + 4q^{n+1, k+1}_{j} + h^{n+1, k+1}_{j-1}(1 - r*u^{n+1, k}_{j+1}) = q^{n-1}_{j+1} + 4q^{n-1}_{j} + q^{n-1}_{j-1} -r(4(q^n_{j+1}u^n_{j+1} + g\frac{({h^2})^n_{j+1}}{2} - q^n_{j-1}u^n_{j-1} - g\frac{({h^2})^n_{j-1}}{2}) +     q^{n-1}_{j+1}u^{n-1}_{j+1} + g\frac{({h^2})^{n-1}_{j+1}}{2} - q^{n-1}_{j-1}u^{n-1}_{j-1} - g\frac{({h^2})^{n-1}_{j-1}}{2}) - \frac{rg}{2}((h^2)^{n+1, k+1}_{j+1} (h^2)^{n+1, k+1}_{j} (h^2)^{n+1, k+1}_{j-1})$
