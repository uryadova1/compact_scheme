...
def relative_errors_and_local_orders_graphic():
    ...
    path_part = './check/'  # './snapshots/'

    h_1_05 = np.load(path_part + "h_T=0.5_n=1001_const_dt.npy", allow_pickle=True)
    q_1_05 = np.load(path_part + "q_T=0.5_n=1001_const_dt.npy", allow_pickle=True)

    h_2_05 = np.load(path_part + "h_T=0.5_n=2001_const_dt.npy", allow_pickle=True)
    q_2_05 = np.load(path_part + "q_T=0.5_n=2001_const_dt.npy", allow_pickle=True)

    h_4_05 = np.load(path_part + "h_T=0.5_n=4001_const_dt.npy", allow_pickle=True)
    q_4_05 = np.load(path_part + "q_T=0.5_n=4001_const_dt.npy", allow_pickle=True)
