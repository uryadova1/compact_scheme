...
def relative_errors_and_local_orders_graphic():
    ...
    h_1_05 = np.load(path_part + "h_T=1_n=101_const_dt.npy", allow_pickle=True)
    q_1_05 = np.load(path_part + "q_T=1_n=101_const_dt.npy", allow_pickle=True)

    h_2_05 = np.load(path_part + "h_T=1_n=201_const_dt.npy", allow_pickle=True)
    q_2_05 = np.load(path_part + "q_T=1_n=201_const_dt.npy", allow_pickle=True)

    h_4_05 = np.load(path_part + "h_T=1_n=401_const_dt.npy", allow_pickle=True)
    q_4_05 = np.load(path_part + "q_T=1_n=401_const_dt.npy", allow_pickle=True)
