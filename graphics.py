...
def relative_errors_and_local_orders_graphic():
    ...
    # path_part = './gg/'  # './snapshots/'
    path_part = './snapshots/'

    h_1_05 = np.load(path_part + "h_T=0.5_n=101_const_dt.npy", allow_pickle=True)
    q_1_05 = np.load(path_part + "q_T=0.5_n=101_const_dt.npy", allow_pickle=True)

    h_2_05 = np.load(path_part + "h_T=0.5_n=201_const_dt.npy", allow_pickle=True)
    q_2_05 = np.load(path_part + "q_T=0.5_n=201_const_dt.npy", allow_pickle=True)

    h_4_05 = np.load(path_part + "h_T=0.5_n=401_const_dt.npy", allow_pickle=True)
    q_4_05 = np.load(path_part + "q_T=0.5_n=401_const_dt.npy", allow_pickle=True)

    h_1_1 = np.load(path_part + "h_T=1.0_n=101_const_dt.npy", allow_pickle=True)
    q_1_1 = np.load(path_part + "q_T=1.0_n=101_const_dt.npy", allow_pickle=True)

    h_2_1 = np.load(path_part + "h_T=1.0_n=201_const_dt.npy", allow_pickle=True)
    q_2_1 = np.load(path_part + "q_T=1.0_n=201_const_dt.npy", allow_pickle=True)

    h_4_1 = np.load(path_part + "h_T=1.0_n=401_const_dt.npy", allow_pickle=True)
    q_4_1 = np.load(path_part + "q_T=1.0_n=401_const_dt.npy", allow_pickle=True)
    ...
    print(h_1_05[0], h_2_05[0], h_4_05[0])

    print(h_1_1[0], h_2_1[0], h_4_1[0])
    ...
    local_orders_2 = local_orders(h_1_1, h_2_1, h_4_1, q_1_1, q_2_1, q_4_1)
    # local_orders_4 = local_orders(h_1_25, h_2_25, h_4_25, q_1_25, q_2_25, q_4_25)
